...
urlpatterns = [
    ...
    re_path('^pessoas_update/(?P<id>\d+)/$', pessoa_update, name='core_pessoa_update'),
    re_path('^pessoas_delete/(?P<id>\d+)/$', pessoa_delete, name='core_pessoa_delete'),
    ...
    re_path('^update_veiculo/(?P<id>\d+)/$', veiculo_update, name='core_veiculo_update'),
    re_path('^delete_veiculo/(?P<id>\d+)/$', veiculo_delete, name='core_veiculo_delete'),
    ...
    re_path('^update-rotat/(?P<id>\d+)/$', update_rotativo, name='core_update_rotativo'),
    re_path('^delete-rotat/(?P<id>\d+)/$', delete_rotat, name = 'core_delete_rotativo'),
    ...
    re_path('^updatemensal/(?P<id>\d+)/$', update_mensal, name='core_update_mensal'),
    re_path('^delete_mensal/(?P<id>\d+)/$', delete_mensal, name='core_delete_mensal'),
